...
DeclareContext::DeclareContext() : m_eventData{}, m_constraintData{} {}

void DeclareContext::addUnaryConstraintData(ConstraintType type,
...
void DeclareContext::addBinaryConstraintData(ConstraintType type,
...
std::vector<DeclareContext::ConstraintData>
DeclareContext::getConstraintData() {
  return m_constraintData;
}

std::vector<Event> DeclareContext::getEventData() { return m_eventData; }

u_int64_t DeclareContext::getEventDataCount() { return m_eventData.size(); }

void DeclareContext::addConstraintDataAndEventDataToSet(
...
u_int64_t
DeclareContext::eventNameToNumericValue(const std::string &event_name) {
