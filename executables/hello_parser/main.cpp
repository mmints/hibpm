...
int main(int argc, char **argv) {
  ...
  DeclareContext declareContext = parser.parseFromFile(
      "../../../Resources/bpi_2017_kb.txt"); // FIXME: Make a relative path in
                                             // CMake
  // DeclareContext declareContext =
  // parser.parseFromFile("../../../Resources/BPIC2020/models/sup75_conf"); //
  // FIXME: Make a relative path in CMake

  DeclareKnowledgeBase declareKnowledgeBase(declareContext);

  std::vector<shared_ptr<Constraint>> rules =
