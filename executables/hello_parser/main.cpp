...
int main(int argc, char** argv)
{
    ...
    DeclareContext declareContext = parser.parseFromFile("../../../Resources/BPIC2020/models/sub75_conf12-5_int12-5/DomesticDeclarations.txt"); // FIXME: Make a relative path in CMake
