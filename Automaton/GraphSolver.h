...
#ifndef DECLARE_PARSER_GRAPHSOLVER_H
#define DECLARE_PARSER_GRAPHSOLVER_H

#include <vector>
#include "Process/State.hpp"
#include <memory>
#include "Process/Binary.hpp"
...
protected:
    ...
    struct Cell{
        bool    FUTURE_POS, FUTURE_NEG,
                NEXT_POS, NEXT_NEG,
                PREV_POS, PREV_NEG,
                PAST_POS, PAST_NEG,
                EXISTS_POS, EXISTS_NEG;
...
#endif //DECLARE_PARSER_GRAPHSOLVER_H
